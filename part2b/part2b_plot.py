...
ax = fig.gca()
ax.set_title("Normalized speedup by number of threads", pad=16, fontsize=20)
...
ax.set_xlabel("Number of threads", labelpad=16, fontsize=16)
ax.set_ylabel("Normalized speedup", labelpad=16, fontsize=16)
...
plt.savefig("./part2b/plots/part2b.pdf")